...
model = DQN("MlpPolicy", env=env, verbose=1, learning_rate=0.0001, tensorboard_log='./tmp_tensorboard', n_steps=100)
for i in range(1):
    model.learn(total_timesteps=2000000, log_interval=1, progress_bar=True)
